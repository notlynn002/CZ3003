...
# Copy of the tower backend script ("res://Backend/TowerBackend.gd")
# Modified to not use the Firebase Singleton
...
func _on_login_succeeded(auth_result):
	emit_signal("login_succeeded", auth_result)
...
func _query_level_attempts(student_id: String, level_id: String, type: String, correct: bool = false) -> Array:
...
func get_correct_for_tower_by_student(student_id: String, tower_id: String):
...
func get_level_display_info(student_id: String, tower_id: String) -> Dictionary:
